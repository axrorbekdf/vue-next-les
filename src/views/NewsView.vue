<template>
    <div>
            ...
            <nav class="navbar w-full">
                ...
                <li class="js-nav-dropdown group relative">
                    ...
                    <li>
                        ...
                        class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                        >
                        <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 1 RTL</span>
                        </a>
                    </li>
                    <li>
                        <a
                    ...
                    <li>
                        ...
                        class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                        >
                        <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 4</span>
                        </a>
                    </li>
                    <li>
                        <a
                    ...
                    <li>
                        ...
                        >
                        <span class="mr-4 font-display text-sm text-accent">Home 7</span>
                    ...
                    <li>
                        ...
                        class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                        >
                        <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 9</span>
                        <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                            >new</span
                        >
                        </a>
                    ...
                    <li>
                        ...
                        class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                        >
                        <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 10</span>
                        <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                            >new</span
                        >
                        </a>
                    ...
                    <li>
                        ...
                        class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                        >
                        <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 11</span>
                        <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                            >new</span
                        >
                        </a>
        ...
        <main>
            <!-- Hero -->
            <section class="relative pb-32 pt-20 lg:pt-48">
                ...
                <div class="h-full items-center gap-4 lg:grid lg:grid-cols-12">
                    <div class="col-span-5 flex h-full flex-col items-center justify-center py-10 lg:items-start lg:py-20">
                    <p class="mb-10 text-xs font-bold uppercase text-jacarta-500 dark:text-jacarta-200">
                        Discover How To Earn More
                    </p>
                    <h1
                        class="mb-6 text-center font-display text-5xl text-jacarta-700 dark:text-white lg:text-left lg:text-6xl"
                    >
                        We Ensure & Transform NFT Business Growing
                    </h1>
                    <p class="mb-8 max-w-md text-center text-lg dark:text-jacarta-200 lg:text-left">
                    ...
                    <div class="relative text-center lg:pl-32 lg:text-right">
                        <div
                        class="absolute -left-[18%] top-1/3 inline-block animate-fly rounded-2lg bg-[#EAF7E1] p-6 shadow-2xl sm:left-[5%] md:left-20"
                        >
                        <div class="flex gap-4">
                            ...
                            <div class="text-left">
                            <span class="block font-display text-3xl text-green">3x</span>
                            <span class="block font-display text-sm text-jacarta-600">Increased Profits</span>
                            </div>
                        </div>
                        </div>
                        <img
                        ...
                        class="inline-block rounded-2.5xl"
                        />

                        <div
                        class="absolute bottom-0 -right-[5%] inline-block animate-fly rounded-2lg bg-white p-8 shadow-2xl sm:bottom-28 sm:right-[5%] lg:-right-[17%]"
                        >
                        <div class="text-left">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            width="24"
                            height="24"
                            class="absolute right-6 top-6 fill-red"
                            >
                            <path fill="none" d="M0 0H24V24H0z" />
                            <path
                            ...
                            <span class="block font-display text-3xl text-[#737EF2]">+10k</span>
                            <span class="mb-5 block font-display text-sm text-jacarta-600">Happy customers</span>
            ...
            <section class="py-24 dark:bg-jacarta-900">
                ...
                <div class="mx-auto mb-12 max-w-xl text-center">
                    ...
                    Connect our AI to your exchange account and invest crypto automatically. Xhibiter app work while you just
                    live.
                    </p>
                </div>
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div
                    class="relative rounded-2.5xl border border-jacarta-100 bg-white p-10 pt-12 transition-shadow hover:shadow-xl dark:border-jacarta-700 dark:bg-jacarta-700"
                    >
                    <span class="absolute top-10 left-12 block h-10 w-10 rounded-full bg-[#DCD0FF] dark:bg-accent"></span>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="24"
                        height="24"
                        class="relative mb-6 h-8 w-8 fill-accent-dark dark:fill-white"
                    >
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path
                    ...
                    <h3 class="mb-4 font-display text-lg text-jacarta-700 dark:text-white">NFT Consultant Analytics</h3>
                    ...
                    <h3 class="mb-4 font-display text-lg text-jacarta-700 dark:text-white">NFT Marketing</h3>
                    <p class="dark:text-jacarta-300">
                        Once you've set up your wallet of choice, connect it to OpenSeaby clicking the NFT Marketplacein the top
                        right corner.
                    </p>
                    ...
                    <h3 class="mb-4 font-display text-lg text-jacarta-700 dark:text-white">NFT Strategy</h3>
                    <p class="dark:text-jacarta-300">
                        Once you've set up your wallet of choice, connect it to OpenSeaby clicking the NFT Marketplacein the top
                        right corner.
                    </p>
                    ...
                    <h3 class="mb-4 font-display text-lg text-jacarta-700 dark:text-white">NFT Technology</h3>
                    <p class="dark:text-jacarta-300">
                        Once you've set up your wallet of choice, connect it to OpenSeaby clicking the NFT Marketplacein the top
                        right corner.
                    </p>
                    ...
                    <h3 class="mb-4 font-display text-lg text-jacarta-700 dark:text-white">Advisers & Intermediaries</h3>
                    <p class="dark:text-jacarta-300">
                        Once you've set up your wallet of choice, connect it to OpenSeaby clicking the NFT Marketplacein the top
                        right corner.
                    </p>
                    ...
                    <h3 class="mb-4 font-display text-lg text-jacarta-700 dark:text-white">ICO Token</h3>
                    <p class="dark:text-jacarta-300">
                        Once you've set up your wallet of choice, connect it to OpenSeaby clicking the NFT Marketplacein the top
                        right corner.
                    </p>
            ...
            <!-- Testimonials -->
            <section class="bg-light-base py-24 dark:bg-jacarta-900">
                <div
                ...
                <div class="mx-auto mb-12 max-w-sm text-center">
                    ...
                    <p class="text-lg dark:text-jacarta-300">10,000k+ Customers those who already tried our services.</p>
                </div>
                ...
                <div class="swiper card-slider-2-columns xl:!overflow-visible">
                    ...
                    <div class="swiper-slide">
                        <div class="flex flex-wrap gap-5 rounded-2.5xl bg-white p-12 dark:bg-jacarta-700 lg:flex-nowrap">
                        <img
                            src="img/testimonials/testimonial_1.jpg"
                            alt=""
                            class="w-28 self-start rounded-2.5xl lg:w-auto"
                        />
                        <div
                            class="-ml-14 -mt-4 flex h-16 w-16 shrink-0 items-center justify-center rounded-full border-[5px] border-white bg-accent dark:border-jacarta-700 md:mb-0 md:w-16"
                        >
                        ...
                        <div class="mb-4 md:mb-0">
                            ...
                            <p class="text-md leading-normal text-jacarta-700 dark:text-white">
                            Xhibiter is one of the most exciting, if you're interested in shaping a new business model for
                            creators, this is the team to join.
                            </p>
                            <span class="mt-6 block font-display text-sm font-medium text-jacarta-700 dark:text-white"
                            >Katie Smith</span
                            >
                            <span class="text-2xs font-medium tracking-tight dark:text-jacarta-400"
                            >General Partner at Entrepreneur</span
                            >
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="mb-4 md:mb-0">
                            ...
                            <span class="mt-6 block font-display text-sm font-medium text-jacarta-700 dark:text-white"
                            >Marshal Ericson</span
                            >
                            <span class="text-2xs font-medium tracking-tight dark:text-jacarta-400">NFT Entrepreneur</span>
                        </div>
                        </div>
                    </div>
                    </div>
            ...
            <section class="relative py-24 dark:bg-jacarta-800">
                ...
                <div class="justify-between lg:flex lg:space-x-20">
                    ...
                    <p class="mb-12 text-lg dark:text-jacarta-300">
                        The most comprehensive complete-system warranty in the solar industry. Hassle-free replacement, repair
                        or reimbursement.
                    </p>
                    <div class="accordion mb-14" id="accordionFAQ">
                        ...
                        <h2 class="accordion-header" id="faq-heading-1">
                            <button
                            class="accordion-button relative flex w-full items-center justify-between bg-white px-4 py-3 text-left font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white"
                            type="button"
                    ...
                    <p class="text-lg text-jacarta-700 dark:text-jacarta-100">
                        Any Question? <a href="#" class="text-accent">support@xhibiter.com</a>
                    </p>
                    </div>
                    <div class="lg:w-[55%]">
                    <div class="mt-12 md:flex md:space-x-8 lg:justify-end">
                        <div class="relative mb-8 max-w-[13.125rem] self-end rounded-2.5xl bg-green p-8 shadow-2xl">
                        <img
                            src="img/patterns/pattern_circle_1.png"
                            class="absolute -top-10 -left-8 -z-10 animate-fly dark:z-0 dark:opacity-10"
                            alt=""
                        />
                        <div>
                            <span class="mb-4 block font-display text-base text-white">Individual Investors</span>
                            <span class="mb-4 block font-display text-4xl text-white">7,000+</span>
                            <span class="block text-base text-white">Sed do eiusmod tempor.</span>
                        </div>
                        </div>
                        <img src="img/crypto-consultant/faq.jpg" class="mb-8 inline-block rounded-2.5xl" alt="" />
                    </div>
                    <div class="relative">
                        <img
                        src="img/patterns/pattern_circle_2.png"
                        class="absolute -bottom-8 right-12 animate-fly dark:opacity-10"
                        alt=""
                        />
                        <div class="relative mx-auto max-w-xs self-start rounded-2.5xl bg-blue p-8 shadow-2xl">
                        <div class="absolute right-8 top-8 rounded-full bg-white p-3">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            width="24"
                        ...
                        <div class="text-left">
                            <span class="mb-4 block font-display text-base text-white">Invested to date</span>
                            <span class="mb-4 block font-display text-4xl text-white">$3.7B</span>
                            <span class="block text-base text-white">Sed do eiusmod tempor.</span>
                        </div>
                        </div>
                    </div>
            ...
            <!-- Blog -->
            <section class="bg-light-base py-24 pb-80 dark:bg-jacarta-900">
                <div class="container">
                <div class="mx-auto mb-12 max-w-sm text-center">
                    <h2 class="mb-6 text-center font-display text-3xl font-medium text-jacarta-700 dark:text-white">
                    Financial News
                ...
                <!-- Slider -->
                <div class="swiper card-slider-3-columns-large-gap">
                    <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide">
                        ...
                        <div class="mb-4 flex flex-wrap gap-4 text-2xs dark:text-jacarta-300">
                            ...
                            <span class="text-accent">
                                <a href="single-post.html" class="uppercase">Finance</a>
                            </span>
                            </div>
                            <span><time datetime="2022-02-05">5 Feb, 2022</time></span>
                        </div>

                        <h2
                            class="mb-5 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent"
                        >
                            <a href="single-post.html">10 Marketing Trends That You Should Be Prepared for in 2022</a>
                        </h2>
                        ...
                        <div class="overflow-hidden">
                            <a
                            href="single-post.html"
                            class="h-rotate inline-block transition-transform will-change-transform hover:translate-x-1"
                            >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                    ...
                    <div class="swiper-slide">
                        ...
                        <h2
                            class="mb-5 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent"
                        >
                            <a href="single-post.html">Expanding the Global NFT Ecosystem: A Preview of Chain Expansion</a>
                        </h2>
                        <p class="mb-8 dark:text-jacarta-300">
                            The goal of this new editor is to make adding rich content to WordPress simple…
                        </p>
            ...
            <!-- CTA -->
            <div class="relative z-10 -mt-48 pb-80 dark:bg-jacarta-900">
                <div class="container">
                <div class="relative overflow-hidden rounded-2.5xl px-16 pt-16 pb-8 shadow-md lg:px-24">
                    <picture class="pointer-events-none absolute inset-0 -z-10 dark:hidden">
                    <img src="img/gradient_light.jpg" alt="gradient" class="h-full w-full" />
                    </picture>
            ...
            <!-- end cta -->
             ...
             <!-- CTA -->
             <div class="relative z-10 -mt-48 dark:bg-jacarta-900">
                <div class="container">
                <div class="relative overflow-hidden rounded-2.5xl px-16 pt-16 pb-8 shadow-md lg:px-24">
                    <picture class="pointer-events-none absolute inset-0 -z-10 dark:hidden">
                    <img src="img/gradient_light.jpg" alt="gradient" class="h-full w-full" />
